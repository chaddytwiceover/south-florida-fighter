...
//#region node_modules/.nitro/vite/services/ssr/assets/router-GchBaJrR.js
var router_GchBaJrR_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var $$splitComponentImporter = () => import("./routes-C1ibut-g.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router_GchBaJrR_exports as t };
